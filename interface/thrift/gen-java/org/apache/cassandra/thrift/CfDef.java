...
public class CfDef implements org.apache.thrift.TBase<CfDef, CfDef._Fields>, java.io.Serializable, Cloneable, Comparable<CfDef> {
  ...
  private static final org.apache.thrift.protocol.TField BUFFER_POPULATE_OPEN_FIELD_DESC = new org.apache.thrift.protocol.TField("buffer_populate_open", org.apache.thrift.protocol.TType.BOOL, (short)47);
  ...
  public boolean buffer_populate_open; // optional
  /**
   * @deprecated
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BUFFER_POPULATE_OPEN((short)47, "buffer_populate_open"),
    /**
     * @deprecated
     */
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 47: // BUFFER_POPULATE_OPEN
          return BUFFER_POPULATE_OPEN;
  ...
  private static final int __BUFFER_POPULATE_OPEN_ISSET_ID = 11;
  ...
  static {
    ...
    tmpMap.put(_Fields.MAX_INDEX_INTERVAL, new org.apache.thrift.meta_data.FieldMetaData("max_index_interval", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.BUFFER_POPULATE_OPEN, new org.apache.thrift.meta_data.FieldMetaData("buffer_populate_open", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public CfDef(CfDef other) {
    ...
    this.buffer_populate_open = other.buffer_populate_open;
  ...
  public void clear() {
    ...
    setBuffer_populate_openIsSet(false);
    this.buffer_populate_open = false;
  ...
  public boolean isBuffer_populate_open() {
    return this.buffer_populate_open;
  }

  public CfDef setBuffer_populate_open(boolean buffer_populate_open) {
    this.buffer_populate_open = buffer_populate_open;
    setBuffer_populate_openIsSet(true);
    return this;
  }

  public void unsetBuffer_populate_open() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __BUFFER_POPULATE_OPEN_ISSET_ID);
  }

  /** Returns true if field buffer_populate_open is set (has been assigned a value) and false otherwise */
  public boolean isSetBuffer_populate_open() {
    return EncodingUtils.testBit(__isset_bitfield, __BUFFER_POPULATE_OPEN_ISSET_ID);
  }

  public void setBuffer_populate_openIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __BUFFER_POPULATE_OPEN_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BUFFER_POPULATE_OPEN:
      if (value == null) {
        unsetBuffer_populate_open();
      } else {
        setBuffer_populate_open((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case BUFFER_POPULATE_OPEN:
      return Boolean.valueOf(isBuffer_populate_open());
  ...
  public boolean isSet(_Fields field) {
    ...
    case BUFFER_POPULATE_OPEN:
      return isSetBuffer_populate_open();
    case ROW_CACHE_SIZE:
  ...
  public boolean equals(CfDef that) {
    ...
    boolean this_present_buffer_populate_open = true && this.isSetBuffer_populate_open();
    boolean that_present_buffer_populate_open = true && that.isSetBuffer_populate_open();
    if (this_present_buffer_populate_open || that_present_buffer_populate_open) {
      if (!(this_present_buffer_populate_open && that_present_buffer_populate_open))
        return false;
      if (this.buffer_populate_open != that.buffer_populate_open)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_buffer_populate_open = true && (isSetBuffer_populate_open());
    list.add(present_buffer_populate_open);
    if (present_buffer_populate_open)
      list.add(buffer_populate_open);
  ...
  public int compareTo(CfDef other) {
    ...
    lastComparison = Boolean.valueOf(isSetBuffer_populate_open()).compareTo(other.isSetBuffer_populate_open());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuffer_populate_open()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.buffer_populate_open, other.buffer_populate_open);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetBuffer_populate_open()) {
      if (!first) sb.append(", ");
      sb.append("buffer_populate_open:");
      sb.append(this.buffer_populate_open);
      first = false;
    }
    if (isSetRow_cache_size()) {
      if (!first) sb.append(", ");
  ...
  private static class CfDefStandardScheme extends StandardScheme<CfDef> {
        ...
        switch (schemeField.id) {
          ...
          case 47: // BUFFER_POPULATE_OPEN
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.buffer_populate_open = iprot.readBool();
              struct.setBuffer_populate_openIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CfDef struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBuffer_populate_open()) {
        oprot.writeFieldBegin(BUFFER_POPULATE_OPEN_FIELD_DESC);
        oprot.writeBool(struct.buffer_populate_open);
        oprot.writeFieldEnd();
      }
